/*
 * File: bluerov_teleop/src/teleop_joy.cpp
 * Author: Josh Villbrandt <josh@javconcepts.com>
 * Date: February 2016
 * Description: Manual remote control of ROVs like the bluerov_teleop.
 */
...
#include <bluerov_teleop/teleop_joyConfig.h>
...
class TeleopJoy {
  ...
  private:
    ...
    void configCallback(bluerov_teleop::teleop_joyConfig &update, uint32_t level);
    ...
    // dynamic reconfigure
    dynamic_reconfigure::Server<bluerov_teleop::teleop_joyConfig> server;
    bluerov_teleop::teleop_joyConfig config;
...
TeleopJoy::TeleopJoy() {
  ...
  dynamic_reconfigure::Server<bluerov_teleop::teleop_joyConfig>::CallbackType f;
...
void TeleopJoy::configCallback(bluerov_teleop::teleop_joyConfig &update, uint32_t level) {
